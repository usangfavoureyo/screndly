  ...
  return (
    <div className="space-y-6">
      <VideoStudioHeader
        ...
        onNewProject={() => onNavigate('video-studio-activity')}
      />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
                {captionTemplates.map((template) => (
                  <button
                    ...
                    className={`px-2 sm:px-3 lg:px-4 py-2 rounded-lg border transition-all duration-200 text-sm sm:text-base whitespace-normal min-h-[40px] flex items-center justify-center ${captionTemplate === template
