...
import { X, Key, Video, MessageSquare, Rss, Globe, AlertTriangle, Trash2, Smartphone, Palette, Bell, Download, Search, ChevronRight, LogOut, FileText, Mail, Film, Image, Clapperboard } from 'lucide-react';
  ...
  const settingsItems = [
    {
      ...
      keywords: [
        ...
        'photopea', 'photopea api key', 'design studio', 'image editing',
  ...
  if (activeSettingsPage === 'apikeys') {
    return (
      <>
        ...
        />
        <ApiKeysSettings settings={settings} updateSetting={updateSetting} onBack={handleCloseSubpage} />
      </>
    );
  }
