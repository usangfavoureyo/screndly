...
import { getDesignStudioActivities, DesignStudioActivity } from '../utils/activityStore';
...
export function DesignStudioActivityPage({ onNavigate, previousPage }: DesignStudioActivityPageProps) {
  ...
  // Load activities and rendered designs
  const [activities, setActivities] = useState<DesignStudioActivity[]>(() => {
    const stored = getDesignStudioActivities();
      ...
      return [
        {
          ...
          details: {
            templateName: 'News Card Template',
            designId: 'design-1',
          },
        },
        {
          ...
          details: {
            templateName: 'Story Post Template',
            designId: 'design-2',
    ...
    return stored.filter(shouldKeepItem);
  });
