  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`grid gap-4 ${isCompactLayout ? 'grid-cols-2' : 'grid-cols-2 lg:grid-cols-5'}`}>
        ...
        <div className={`bg-white dark:bg-[#000000] border border-gray-200 dark:border-[#333333] rounded-2xl shadow-sm p-5 ${isCompactLayout ? 'col-span-2' : 'col-span-2 lg:col-span-1'}`}>
