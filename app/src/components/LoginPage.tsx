          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`flex h-4 w-4 items-center justify-center rounded-[4px] border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ec1e24]/40 disabled:cursor-not-allowed disabled:opacity-50 ${
                  rememberMe
                    ? 'border-[#ec1e24] bg-[#ec1e24] text-white'
                    : 'border-gray-300 bg-white text-transparent dark:border-[#333333] dark:bg-[#000000]'
                }`}
              >
                <Check className={`h-3 w-3 stroke-[3] ${rememberMe ? 'opacity-100' : 'opacity-0'}`} />
              </button>
              <Label
                id="remember-label"
                htmlFor="remember"
