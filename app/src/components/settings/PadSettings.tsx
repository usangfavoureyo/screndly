    ...
    <div className="fixed top-0 right-0 bottom-0 z-50 w-full overflow-y-auto bg-white dark:bg-[#000000] lg:w-[600px]">
      <div className="sticky top-0 border-b border-gray-200 bg-white p-4 dark:border-[#333333] dark:bg-[#000000]">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-gray-900 dark:text-white">PAD Settings</h2>
            <p className="text-sm text-[#6B7280] dark:text-[#9CA3AF]">Choose the default PAD chat model and the starting system prompt for new chats.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6 p-6">
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-[#333333] dark:bg-[#000000]">
          <Label className="text-gray-600 dark:text-[#9CA3AF]">PAD Chat Model</Label>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-[#333333] dark:bg-[#000000]">
          ...
          <Textarea
            ...
            placeholder="Set the default PAD instructions that new chats start with."
          />
        </div>
      </div>
    </div>
