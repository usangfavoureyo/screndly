...
const PadSettings = lazyWithRetry(() => import('./settings/PadSettings').then((module) => ({ default: module.PadSettings })), 'PadSettings');
const ComposeSettings = lazyWithRetry(() => import('./settings/ComposeSettings').then((module) => ({ default: module.ComposeSettings })), 'ComposeSettings');
