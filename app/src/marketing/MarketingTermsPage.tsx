        ...
        <div className="mx-auto w-full max-w-4xl px-6 py-16 text-sm text-neutral-600 lg:px-10 lg:py-20">
          <FadeIn>
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-neutral-900">Authorized publishing</h2>
                <p className="mt-2">
              ...
              <div>
                <h2 className="text-lg font-semibold text-neutral-900">User responsibility</h2>
                <p className="mt-2">
              ...
              <div>
                <h2 className="text-lg font-semibold text-neutral-900">Service availability</h2>
                <p className="mt-2">
