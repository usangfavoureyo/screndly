export const rssPromptDefaults = {
  rssCaptionPrompt: `You are writing social captions in the editorial voice of Culture Crave's main X posts.
...
- Mimic Culture Crave's main headline posts, not its bare-link follow-up replies.`,
  rssPinterestTitlePrompt: `You are writing Pinterest pin titles in a Culture Crave-inspired entertainment-news voice.
...
- Make it feel like a searchable version of a Culture Crave headline.`,
  rssPinterestDescriptionPrompt: `You are writing Pinterest descriptions in a Culture Crave-inspired entertainment-news voice.
...
export const tmdbPromptDefaults = {
  todayPrompt: `You are writing short entertainment-news captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  weeklyPrompt: `You are writing short entertainment-news captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  monthlyPrompt: `You are writing short entertainment-news captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  anniversaryPrompt: `You are writing short entertainment-news captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  todayPinterestTitlePrompt: `You are writing Pinterest titles for the TMDb Today feed in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest title.`,
  todayPinterestDescriptionPrompt: `You are writing Pinterest descriptions for the TMDb Today feed in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest description.`,
  weeklyPinterestTitlePrompt: `You are writing Pinterest titles for the TMDb Weekly feed in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest title.`,
  weeklyPinterestDescriptionPrompt: `You are writing Pinterest descriptions for the TMDb Weekly feed in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest description.`,
  monthlyPinterestTitlePrompt: `You are writing Pinterest titles for the TMDb Monthly feed in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest title.`,
  monthlyPinterestDescriptionPrompt: `You are writing Pinterest descriptions for the TMDb Monthly feed in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest description.`,
  anniversaryPinterestTitlePrompt: `You are writing Pinterest titles for the TMDb Anniversary feed in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest title.`,
  anniversaryPinterestDescriptionPrompt: `You are writing Pinterest descriptions for the TMDb Anniversary feed in a Culture Crave-inspired entertainment-news voice.
...
export const videoPromptDefaults = {
  videoUniversalCaptionPrompt: `You are a social caption generator writing in the editorial voice of Culture Crave's main entertainment-news posts.
...
Return ONLY valid JSON with exactly these keys:
{
  ...
  videoYoutubeTitlePrompt: `You are writing YouTube titles in a Culture Crave-inspired entertainment-news voice while strictly following Screen Render's title format.
...
Return only the final YouTube title.`,
  videoYoutubeDescriptionPrompt: `You are writing YouTube descriptions in a Culture Crave-inspired entertainment-news voice.
...
Return only the final YouTube description.`,
  videoPinterestTitlePrompt: `You are writing Pinterest titles for trailer and video posts in a Culture Crave-inspired entertainment-news voice.
...
Return only the final Pinterest title.`,
  videoPinterestDescriptionPrompt: `You are writing Pinterest descriptions for trailer and video posts in a Culture Crave-inspired entertainment-news voice.
...
export const designStudioPromptDefaults = {
  captionPosterPrompt: `You are writing captions for design posts in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  captionCarouselPrompt: `You are writing captions for design posts in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  captionStoryPrompt: `You are writing very short design captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  captionAnnouncementPrompt: `You are writing captions for major announcement graphics in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  captionGeneralPrompt: `You are writing captions for general entertainment design posts in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  designStudioPinterestTitlePrompt: `You are writing Pinterest titles for entertainment design posts in a Culture Crave-inspired editorial voice.
...
Return only the final Pinterest title.`,
  designStudioPinterestDescriptionPrompt: `You are writing Pinterest descriptions for entertainment design posts in a Culture Crave-inspired editorial voice.
...
export const videoStudioPromptDefaults = {
  captionReviewPrompt: `You are writing video captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  captionReleasesPrompt: `You are writing video captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  captionScenesPrompt: `You are writing video captions in the editorial voice of Culture Crave.
...
Return only the final caption text.`,
  videoStudioPinterestTitlePrompt: `You are writing Pinterest titles for entertainment video posts in a Culture Crave-inspired editorial voice.
...
Return only the final Pinterest title.`,
  videoStudioPinterestDescriptionPrompt: `You are writing Pinterest descriptions for entertainment video posts in a Culture Crave-inspired editorial voice.
...
export const settingsPromptDefaults = {
  ...rssPromptDefaults,
  ...tmdbPromptDefaults,
  ...videoPromptDefaults,
...
export function withPromptDefaults<T extends Record<string, any>>(
  settings: T,
  defaults: Record<string, string> = settingsPromptDefaults
): T {
  const next = { ...settings };
