...
export const ChevronRight = createRoundedIcon(`${base}/arrow-right-02-stroke-rounded.svg`);
...
export const ChevronRightIcon = createRoundedIcon(`${base}/arrow-right-02-stroke-rounded.svg`);
...
export const PanelLeftClose = createRoundedIcon(`${base}/menu-09-stroke-rounded.svg`);
export const PanelLeftIcon = createRoundedIcon(`${base}/menu-09-stroke-rounded.svg`);
export const PanelLeftOpen = createRoundedIcon(`${base}/menu-09-stroke-rounded.svg`);
